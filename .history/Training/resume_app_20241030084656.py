...
def resume():
    ...
    <head>
        ...
        <title>Resume - [Sri Ram Jetti]</title>
        <style>
            body {
    ...
    <body>
        <div class="header">[Sri Ram Jetti]</div>
        ...
        <div class="content">
            ...
            <div class="section">
                ...
                <p>[Job Title] - [innomax it solutions]</p>
                <p>Briefly describe key accomplishments, highlighting data-driven achievements relevant to Netflix's needs.</p>
            </div>
            
            <div class="section">
                <h2>Education</h2>
                <p>[masters] in [computer science] from [rivier university]</p>
            </div>
            
            <div class="section">
                <h2>Contact</h2>
                <p>Email: [sriramjetti0105@gmail.com]</p>
                <p>LinkedIn: <a href="[https://www.linkedin.com/in/sri-ram-j-106a68313/]">https://www.linkedin.com/in/sri-ram-j-106a68313/</a></p>
            </div>
        </div>
        
        <div class="footer">
            &copy; [2024] - [Sri Ram Jetti]. All rights reserved.
        </div>
    </body>
    </html>
    '''
