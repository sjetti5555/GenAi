...
# Separate features and target variable
# Ensure 'Fatalities' is in the data_encoded DataFrame
if 'Fatalities' in data_encoded.columns:
    X_logistic = data_encoded.drop(['Disaster_ID', 'Date', 'Fatalities', 'Economic_Loss($)'], axis=1)
else:
    print("Fatalities column not found in data_encoded.")
...
y_logistic = data['Fatalities']  # Use the original data for the target variable
