...
X = data.drop('Crunchiness', axis=1)  # Replace 'Crunchiness' with the actual target variable name
y = data['Crunchiness']  # Replace 'Crunchiness' with the actual target variable name
