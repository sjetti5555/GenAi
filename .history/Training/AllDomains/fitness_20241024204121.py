...
X = data.drop('Crunchiness', axis=1)  # Replace 'target_column' with the actual target variable name
y = data['Crunchiness']  # Replace 'target_column' with the actual target variable name
...
# Feature Importance
importances = model.future_importances_
