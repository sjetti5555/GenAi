...
X = data.drop('Crunchiness', axis=1)  # Replace 'loan_amount' with the actual target variable name
y = data['Crunchiness']  # Replace 'loan_amount' with the actual target variable name
...
if 'Crunchiness' in data.columns:
    y_logistic = data['Crunchiness']  # Replace with the actual binary target variable
    X_logistic = data.drop('Crunchiness', axis=1)
