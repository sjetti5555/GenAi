...
X = data.drop('expenses', axis=1)  # Replace 'Crunchiness' with the actual target variable name
y = data['expenses']  # Replace 'Crunchiness' with the actual target variable name
...
if 'expenses' in data.columns:
    y_logistic = data['expenses']  # Replace with the actual binary target variable
    print("Unique values in the target variable for Logistic Regression:", y_logistic.unique())
    X_logistic = data.drop('expenses', axis=1)
