...
X = data.drop('Crunchines', axis=1)  # Replace 'loan_amount' with the actual target variable name
y = data['Crunchines']  # Replace 'loan_amount' with the actual target variable name
...
if 'Crunchines' in data.columns:
    y_logistic = data['Crunchines']  # Replace with the actual binary target variable
    X_logistic = data.drop('Crunchines', axis=1)
