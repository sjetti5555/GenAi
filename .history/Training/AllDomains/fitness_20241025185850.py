...
X = data.drop('bmi', axis=1)  # Replace 'Crunchiness' with the actual target variable name
y = data['bmi']  # Replace 'Crunchiness' with the actual target variable name
...
if 'bmi' in data.columns:
    y_logistic = data['bmi']  # Replace with the actual binary target variable
    print("Unique values in the target variable for Logistic Regression:", y_logistic.unique())
    X_logistic = data.drop('bmi', axis=1)
