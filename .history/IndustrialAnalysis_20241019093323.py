...
map_df = gpd.read_file(r'C:\Users\srira\OneDrive\Desktop\Gen_AI\shapefiles\andhra_pradesh.shp')
...
pca_result = pca.fit_transform(df[['Policy_Investment', 'Employment_Growth', 'Industrial_Output']])
...
plt.title('PCA of Industrial Policy Data')
