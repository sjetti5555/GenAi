...
classification_rep = classification_report(y_test, y_pred_log, zero_division=1)
...
# Step 7: Generate a synthetic dataset for Random Forest Classifier
X_classification, y_classification = make_classification(n_samples=1000, n_features=20, n_classes=3, n_informative=10, n_redundant=5, random_state=42)
...
report = classification_report(y_test_class, y_pred_class, zero_division=1)
print(report)
