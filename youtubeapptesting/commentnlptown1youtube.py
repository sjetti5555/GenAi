...
# 3. Perform Sentiment Analysis (Batched)
...
# 4. Determine Sentiment Label (Positive/Negative/Neutral)
...
if __name__ == "__main__":
    ...
    output_file = f"{VIDEO_ID}_YTCA.csv"
